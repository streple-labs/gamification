      ...
      <section className="flex flex-col gap-8 w-full">
        ...
        <div className="grid grid-cols-4 gap-6 pb-10">
          {[
            {
              name: "Calero",
              avatar: "/traders-pfp-1.jpg",
              badge: "/traders-badge-1.png",
              followers: "4",
              roi: "+129.38%",
              risk: "2.4/10",
            },
            {
              name: "Maldivaaa",
              avatar: "/traders-pfp-2.jpg",
              badge: "/traders-badge-2.png",
              followers: "2",
              roi: "+85.12%",
              risk: "3.1/10",
            },
            {
              name: "TraderX",
              avatar: "/traders-pfp-3.jpg",
              badge: "/traders-badge-3.png",
              followers: "10",
              roi: "+200.00%",
              risk: "1.5/10",
            },
