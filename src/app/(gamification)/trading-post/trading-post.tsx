  ...
  return (
    <div className="flex flex-col gap-8 w-full relative">
      ...
      {aboutTradersTutorials === 5 && (
        <div className="fixed right-0 -bottom-9 h-[270px] z-10">
          <Tooltip
            isVisible
            position="left"
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <div
              ...
              } border border-[#BDB5104D] rounded-[20px] backdrop-blur-xs bg-[#EEE3110D] h-[207px] pt-[30px] pl-4 relative overflow-hidden`}
            >
          ...
          <div className="border border-[#503C8B] rounded-[20px] backdrop-blur-xs bg-[#503C8B0D] h-[207px] pt-11 pl-4 relative -z-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <h4
              ...
              } font-normal text-2xl leading-10 relative tracking-[2px] text-white/70`}
            >
              All Traders
            </h4>
          </Tooltip>
          ...
          >
            <div
              ...
              } w-[290px] relative rounded-full border border-white/10 h-[43px] py-3 px-4 flex items-center gap-3`}
            >
                  ...
                  <div className="flex items-center justify-between relative">
                    <div className="flex items-center gap-3.5">
                      ...
                      <div className="space-y-1 w-full">
                        <p
                          className={`${baloo.className} text-base/6 tracking-[2px] font-normal bg-gradient-to-r from-white to-white/0 bg-clip-text text-transparent overflow-hidden text-ellipsis whitespace-nowrap max-w-[120px]`}
                        >
                          {trader.fullName}
                        </p>
