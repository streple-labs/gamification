...
> = {
  ...
  2: {
    ...
    options: [
      ...
      "It’s shared across thousands of computers 🖥️",
      "It can’t be spent 🛑",
    ],
    answer: 2,
  ...
  3: {
    ...
    options: [
      ...
      "It’s owned by one government 🏛️",
...
> = {
  ...
  5: {
    ...
    options: [
      "Watch TV only 📺",
      "Buy land, build a shop, or host events 🏗️🎉",
      "Print more paper money 🖨️💵",
...
> = {
  1: {
    ...
    options: [
      "Teachers in schools 📚",
      "Farmers, tailors, and traders 👨‍🌾👗🛍️",
      "Pilots flying planes ✈️",
